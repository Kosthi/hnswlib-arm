...
void test_some_filtering(hnswlib::BaseFilterFunctor& filter_func,
                         size_t div_num, size_t label_id_start) {
  int d = 4;
  idx_t n = 100;
  idx_t nq = 10;
  size_t k = 10;
  ...
  hnswlib::AlgorithmInterface<float>* alg_brute =
      new hnswlib::BruteforceSearch<float>(&space, 2 * n);
  hnswlib::AlgorithmInterface<float>* alg_hnsw =
      new hnswlib::HierarchicalNSW<float>(&space, 2 * n);
...
void test_none_filtering(hnswlib::BaseFilterFunctor& filter_func,
